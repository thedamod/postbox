...
/**
 * Provider-neutral mail contract for the frontend.
 * Mirrors redakt's `MailProvider`: routes and components program against
 * this interface, and `getMailProvider()` resolves the storage-backed
 * implementation. Domain administration is out of scope for this client.
 */
